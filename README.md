...
FpopPSD is an extension of FPOP, an exact data segmentation algorithm based on functional pruning. This extension implements a non linear penalty which depends on the length of the segments. The algorithmic objective is to solve the following non-convex optimization problem:
